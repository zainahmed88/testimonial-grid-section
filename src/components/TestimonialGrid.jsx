    ...
    <div className="main-container">
      <div className="left-section">
        <div className="left-top-section">
          <div className="testimonial-1">
            <div className="header">
              ...
              <div className="name-section">
                ...
                <p className="qualification">Verified Graduate</p>
              </div>
            </div>
          ...
          <div className="testimonial-2">
            <div className="header">
              <img className="picture" src={imgJonathan} alt="Daniel" />
              <div className="name-section">
        ...
        <div className="left-bottom-section">
          <div className="testimonial-3">
            <div className="header">
              <img className="picture" src={imgJeanette} alt="Daniel" />
              <div className="name-section">
          ...
          <div className="testimonial-4">
            <div className="header">
              <img className="picture" src={imgPatrick} alt="Daniel" />
              <div className="name-section">
      ...
      <div className="right-section">
        <div className="testimonial-5">
          <div className="header">
            <img className="picture" src={imgKira} alt="Daniel" />
            <div className="name-section">
